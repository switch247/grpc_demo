...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ServerSaysHello = channel.unary_stream(
                '/greeter.Greeter/ServerSaysHello',
                request_serializer=greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=greeter__pb2.HelloReply.FromString,
                _registered_method=True)
        self.ClientSaysHello = channel.stream_unary(
                '/greeter.Greeter/ClientSaysHello',
                request_serializer=greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=greeter__pb2.DelayedReply.FromString,
                _registered_method=True)
        self.HybridHello = channel.stream_stream(
                '/greeter.Greeter/HybridHello',
                request_serializer=greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=greeter__pb2.HelloReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ClientSaysHello': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=greeter__pb2.HelloRequest.FromString,
                    response_serializer=greeter__pb2.DelayedReply.SerializeToString,
            ),
            'HybridHello': grpc.stream_stream_rpc_method_handler(
                    servicer.HybridHello,
                    request_deserializer=greeter__pb2.HelloRequest.FromString,
                    response_serializer=greeter__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def ClientSaysHello(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            '/greeter.Greeter/ClientSaysHello',
            greeter__pb2.HelloRequest.SerializeToString,
            greeter__pb2.DelayedReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def HybridHello(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
